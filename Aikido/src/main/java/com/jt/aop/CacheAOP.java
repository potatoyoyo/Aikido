...
public class CacheAOP {
	...
	/**
	 * 1.娣诲姞鐜粫閫氱煡  浣跨敤鐜粫閫氱煡蹇呴』娣诲姞杩斿洖鍊�
	 * 2.鎷︽埅鑷畾涔夋敞瑙�
	 *   闇�姹�: 鍔ㄦ�佽幏鍙栬嚜瀹氫箟娉ㄨВ涓殑鍙傛暟
	 * 宸ヤ綔鍘熺悊璇存槑:
	 * 	瀹氫箟娉ㄨВ鐨勫彉閲忓悕绉�  cacheFind
	 *      閫氱煡鍙傛暟鎺ユ敹鍚嶇О     cacheFind
	 ...
	 * 		2.2 鏈夋暟鎹�      鍔ㄦ�佽幏鍙栫紦瀛樻暟鎹箣鍚庡埄鐢ㄥ伐鍏稟PI杞寲涓虹湡瀹炵殑瀵硅薄.
	 */

	//@Autowired
	//private Jedis jedis;		//鍗曞彴redis
	//@Autowired					
	//private ShardedJedis jedis;//閰嶇疆鍒嗙墖鏈哄埗
	
	//@Autowired //1.鎸夌収绫诲瀷杩涜娉ㄥ叆   2.鎸夌収鍚嶇О鍖归厤
	...
	private Class<?> getReturnType(ProceedingJoinPoint joinPoint) {
		//Signature鏍囪瘑鏂规硶鐨凙PI  鍒╃敤鍙嶅皠鍔ㄦ�佽幏鍙杕ethod瀵硅薄 鑾峰彇杩斿洖鍊�
